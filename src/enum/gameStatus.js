...
export const RULES = [
    "You ger 1 Start, 80 Numbers & 5 Finish cards.",
    "You need to drag cards to the board to fill it in ascending order.",
    "But here's the catch!",
    "When you play a number next to another you discard their difference up to 4 from your hand.",
    "You can only win the game by playing the finish card last.",
